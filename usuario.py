...
class Usuario: #moldeo plantilla
    ...
    def guardar (cls, datos): #SENTENCIAS preparadas para evitar inyecciones SQL, datos es un diccionario 
        query = "INSERT INTO usuarios (nombre, apellido, gmail) VALUES (%(nombre)s, %(apellido)s, %(gmail)s);"
    ...
    def obtener_todos (cls):
        ...
        for resultado in resultados:
            usuarios.append(cls(resultado)) #usamos cls para crear una instancia de la clase Usuario con los datos obtenidos de la base de datos
